      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-8 pb-16 grid lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          {product.badges?.length > 0 && (
            <div className="mt-4 flex flex-wrap gap-2">
              {product.badges.map((badge) => (
                <span
                  key={badge}
                  className="text-xs font-semibold px-3 py-1.5 rounded-full bg-cyan-50 text-cyan-700"
                >
                  {badge}
                </span>
              ))}
          ...
          <p className="mt-3 text-xs text-slate-400">
            As an Amazon Associate, GearNest earns from qualifying purchases
          ...
          {relatedReview && (
            ...
            >
              ...
              <Icon
                name="arrowRight"
                className="w-4 h-4 ml-auto text-slate-300"
              />
            </Link>
          )}
        </div>
